    ...
    public function run()
    {
        $brands = [
            ...
            [   
                "category_id" => 1,
                "name" => "Equity Bank",
                "about" => "Equity Bank Kenya Limited is a financial services provider headquartered in Nairobi, Kenya. It is licensed as a commercial bank by the Central Bank of Kenya, which is the central bank and national banking regulator of Kenya.",
                "rating" => 0.0,
                "website_url" => "https://equitygroupholdings.com/",
                "company_phone" => "+254 763 000 000",
                "company_email" => "info@equitygroupholdings.com",
                "address" => "9th Floor, Equity Centre,Hospital Road, Upper Hill. Nairobi, Kenya",
                "logo_path" => "/images/logos/41.png",
                "is_verified" => 1,
                "is_claimed" => 1,
            ],
            [   
                ...
                "about" => "Co-operative Bank of Kenya is a commercial bank in Kenya, the largest economy in the East African Community. It is licensed by the Central Bank of Kenya, the central bank and national banking regulator.",
                "rating" => 0.0,
                "website_url" => "https://www.co-opbank.co.ke/",
                "company_phone" => "+254 703 027 000",
                "company_email" => "customerservice@co-opbank.co.ke",
                "address" => "Co-operative House, Haile Selassie Avenue. Nairobi, Kenya",
                "logo_path" => "/images/logos/42.png",
                "is_verified" => 1,
                "is_claimed" => 1,
            ],
            [   
                "category_id" => 1,
                "name" => "Family Bank",
                "about" => "Family Bank Limited, commonly known as Family Bank, is a commercial bank in Kenya, the largest economy in the East African Community. It is licensed by the Central Bank of Kenya, the central bank and national banking regulator.",
                "rating" => 0.0,
                "website_url" => "https://familybank.co.ke/",
                "company_phone" => "+254 703 095 445",
                "company_email" => "customerservice@familybank.co.ke",
                "address" => "Kenya Bankers Association, International House, Mama Ngina Street. Nairobi, Kenya",
                "logo_path" => "/images/logos/41.png",
                "is_verified" => 1,
                "is_claimed" => 1,
            ],
            [   
                "category_id" => 1,
                "name" => "ABSA",
                "about" => "Absa Group Limited, and originally Amalgamated Banks of South Africa, is a South African-based financial services group, offering personal and business banking, credit cards, corporate and investment banking, wealth and investment management, as well as bank assurance.",
                "rating" => 0.0,
                "website_url" => "https://www.absabank.co.ke/personal/",
                "company_phone" => "+254 732 130 120",
                "company_email" => "absa.kenya@absa.africa",
                "address" => "Mama Ngina Drive, Opposite International Life House, Nairobi, Kenya",
                "logo_path" => "/images/logos/41.png",
                "is_verified" => 1,
                "is_claimed" => 1,
            ],
